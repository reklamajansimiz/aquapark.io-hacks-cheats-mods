...
// @updateURL    https://iomods.org/mods/aquaparkio.user.js
// @downloadURL  https://iomods.org/mods/aquaparkio.user.js
// @match        *://aquapark.io/*
// @match        *iogames.space/*
// @match        *titotu.io/*
// @match        *io-games.io/*
...
$('#right').append('<div style="'+this.st.formstyle+'"><div class="option1"></div></div>');
