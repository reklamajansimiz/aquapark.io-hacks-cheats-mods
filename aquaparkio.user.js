// ==UserScript==
// @name         Aqaupark.io Swim HACK - Aquaparkio Hacks - Best Aquapark Cheat 2019 to 2020
// @description  Aquaparkio Mods Features: Zoom Hack, Speed Hack, Swim Hack, Auto Spawn, FPS
...
// @updateURL    https://io-mods.com/mods/aquaparkio.user.js
// @downloadURL  https://io-mods.com/mods/aquaparkio.user.js
// @grant          GM_setValue
// @grant          GM_getValue
// @match        *://aquapark.io/*
// @match        *iogames.space/*
...
$('#bottom').prepend('<div class="list1"></div>'+this.st.imagelist+'');
...
document.getElementById("rightbanner").appendChild(styleSelect);
...
var chatInput = document.getElementsByTagName('input');
function mouseOver() {
    ...
    for (var i=0; i < inputs.length; i++)
    {
        ...
        {
            inputs[i].id = "yarak";
            var chatInput = document.getElementById('yarak');
...
document.getElementById("rightbanner").appendChild(stylerSelect);
